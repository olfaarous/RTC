...
<p>
    The GoCloudStorage library is not pre-packaged with GoJS. You can find the GoCloudStorage library <a href="../storage/lib/gcs.js">here</a>.
</p>
<p>
    ...
    <a href="../storage/api/symbols/GoCloudStorage.html">GoCloudStorage class</a> itself is an abstract class, never to be instantiated. 
...
<p>
    ...
    <a href="../storage/api/index.html">documentation</a> for any GoCloudStorage subclass you wish to use.
</p>
<p>
...
<p>
    <strong>Note</strong>: To use any GoCloudStorage subclass (except for <a href="../storage/api/symbols/GoLocalStorage.html">GoLocalStorage</a>), you must 
    ...
    <ul>
            <li><a href="../storage/api/symbols/GoDropBox.html">GoDropBox</a>: https://cdnjs.cloudflare.com/ajax/libs/dropbox.js/2.5.12/Dropbox-sdk.min.js </li>
            <li><a href="../storage/api/symbols/GoGoogleDrive.html">GoGoogleDrive</a>: https://apis.google.com/js/api.js</li>
            <li><a href="../storage/api/symbols/GoOneDrive.html">GoOneDrive</a>: https://js.live.net/v7.2/OneDrive.js </li>
    </ul>
</p>
<p>
...
<pre data-language="javascript" id="simple">
  ...
  var ggd = new gcs.GoGoogleDrive(
    ...
    "../storage/goCloudStorageIcons/" // iconsRelativeDirectory parameter
    );
</pre>
<p>
...
<p>
    ...
    as <code><a href="../storage/api/symbols/GoCloudStorage.html#managedDiagrams">managedDiagrams</a></code>. It is either an Array of
...
<p>
    ...
    <a href="../storage/api/symbols/GoCloudStorage.html#clientId">clientId</a></code> parameter, required by all GoCloudStorage subclasses (except 
    <a href="../storage/api/symbols/GoLocalStorage.html">GoLocalStorage</a>). This ID tells the cloud storage provider (in this case, Google) and the user 
...
<p>
    ...
    <code><a href="../storage/api/symbols/GoCloudStorage.html#create">create</a></code>. Generally, this value is obtained with a call to 
...
<p>
    To use commands that call a GoCloudStorage subclass' custom <code><a href="../storage/api/symbols/GoCloudStorage.html#ui">ui</a></code>,
...
<p>
    All GoCloudStorage subclasses (except <a href="../storage/api/symbols/GoLocalStorage.html">GoLocalStorage</a>) require a client ID as a parameter during construction. 
...
<ol>
    ...
    <p>
        ...
        Subclass Construction</a>. Use this string as the <code><a href="../storage/api/symbols/GoCloudStorage.html#clientId">clientId</a></code> parameter for your
...
<p>
    <code>saveWithUI()</code> shows the <a href="../storage/api/symbols/GoCloudStorage.html#ui">ui</a> element of the invoking instance of
...
<h4>Loading</h4>
    ...
    <p>
        <code><a href="../storage/api/symbols/GoCloudStorage.html#load">load(&#60;valid path string&#62;)</a></code> loads file contents from the cloud storage service and 
        into each of <code>managedDiagrams</code>' models. No UI appears.
        <br />
        <strong>Example</strong>: <code>ggd.load('ahjdhe^3n4dlKd4r')</code>
    </p>
    <p>
        <code><a href="../storage/api/symbols/GoCloudStorage.html#loadWithUI">loadWithUI()</a></code> displays the 
        <a href="../storage/api/symbols/GoCloudStorage.html#ui">ui</a> and lets the user graphically choose which file to load.
        <br />
...
<p>
    ...
    <code><a href="../storage/api/symbols/GoCloudStorage.html#isAutoSaving">ggd.isAutoSaving</a></code> is true, you will be prompted to
...
<ul>
    <li><strong><a href="../storage/api/symbols/GoCloudStorageManager.html#storages">Storages</a></strong></li>
    <p>
    ...
    <li><strong><a href="../storages/api/symbols/GoCloudStorageManager.html#iconsRelativeDirectory">Icons Relative Directory</a></strong></li>
    <p>
...
<p>
    ...
    call to <code><a href="../storage/api/symbols/GoCloudStorageManager.html#selectStorageService">storageManager.selectStorageService()</a></code>. 
    <code><a href="../storage/api/symbols/GoCloudStorageManager.html#currentStorageService">storageManager.currentStorageService</a></code> is set 
...
<p>
    ...
    a <a href="../storage/api/symbols/DiagramFile.html">DiagramFile</a>, representing the recently saved / loaded / created / removed file.  With this data, you may update your
    ...
    <strong>Note</strong>: There are three guaranteed fields in any DiagramFile object: the <a href="../storage/api/symbols/DiagramFile.html#name">name</a>, 
    <a href="../storage/api/symbols/DiagramFile.html#id">id</a>, and <a href="../storage/api/symbols/DiagramFile.html#path">path</a> of the represented file.
</p>

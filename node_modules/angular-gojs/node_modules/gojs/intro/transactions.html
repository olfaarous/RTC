...
<p>
<pre data-language="javascript" id="transactionsDiagram" style="display:none">
...
In the following example the addChild function adds a link connecting the selected node to a new node.

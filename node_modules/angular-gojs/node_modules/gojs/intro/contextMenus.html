...
<p>
A context menu is an <a>Adornment</a> that is shown when the user context-clicks (right mouse click or long touch hold)
...
<h3 id="DefaultContextMenuForTouchEnabledDevices">Default Context Menu for Touch-enabled devices</h3>
<p>

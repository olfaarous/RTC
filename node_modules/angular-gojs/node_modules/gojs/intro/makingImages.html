...
<pre data-language="javascript" id="diag" style="display: none;">
...
<pre data-language="javascript" id="code0">
myDiagram.makeImage();
</pre>
...
<pre data-language="javascript" id="codeA">
myDiagram.makeImage({
  scale: 1
});
</pre>
...
<pre data-language="javascript" id="code1">
myDiagram.makeImage({
  scale: 2
});
</pre>
...
<pre data-language="javascript" id="code2">
myDiagram.makeImage({
...
<pre data-language="javascript" id="code3">
myDiagram.makeImage({
...
<pre data-language="javascript" id="code4a">
...
<pre data-language="javascript" id="code4">
myDiagram.makeImage({
  parts: myPartsList
});
</pre>
...
<pre data-language="javascript" id="code4-2">
myDiagram.makeImage({
...
<pre data-language="javascript" id="code5">
myDiagram.makeImage({
  scale: 1.5,
  size: new go.Size(100,100)
});
...
<pre data-language="javascript" id="code6">
myDiagram.makeImage({
  scale: 9,
...
<pre data-language="javascript" id="code7">
myDiagram.makeImage({
...
<pre data-language="javascript" id="code8">
myDiagram.makeImage({
...
<pre data-language="javascript" id="manyImgCode">
...
<pre data-language="javascript" id="codea1">
myDiagram.makeImage({
  scale: 1,
  type: "image/jpeg"
});
...
<pre data-language="javascript" id="codea2">
myDiagram.makeImage({
  scale: 1,
...
<pre data-language="javascript" id="codea3">
myDiagram.makeImage({
  scale: 1,
  background: "AntiqueWhite",
  type: "image/jpeg",

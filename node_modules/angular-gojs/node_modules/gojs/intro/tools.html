...
<p>While each prebuilt tool in GoJS is used for a different purpose, all Tools are guaranteed to share some functions and properties. 
  ...
  representing the general lifecycle of a tool.
                                                                          <pre data-language="javascript" id="toolLifecycle" style="display: none">
  diagram.nodeTemplate = 
      $(go.Node, "Auto", { locationSpot: go.Spot.Center },
        ...
        $(go.TextBlock, { margin: 8, wrap: go.TextBlock.WrapFit, width: 150 },
          new go.Binding("text")
        )
      );
    ...
    diagram.model = 
      $(go.GraphLinksModel,
      {
        nodeDataArray: 
        [
          { key: 1, text: "toolManager searches tool list (i.e. mouseDownTools)", loc: "50 0" },
          { key: 2, text: "canStart()", loc: "50 100" },
          { key: 3, text: "toolManager.currentTool = the chosen tool", loc: "50 200" },
          { key: 4, text: "doStart()", loc: "50 275" },
          { key: 5, text: "doActivate()", loc: "50 350" },
          { key: 6, text: "isActive === true", loc: "50 425" },
          { key: 7, text: "doMouseDown() |\ndoMouseMove() |\ndoMouseUp() |\ndoMouseWheel() |\ndoKeyDown() |\ndoKeyUp()", loc: "-200 500" },
          { key: 8, text: "doCancel()", loc: "250 500" },
          { key: 9, text: "stopTool()", loc: "50 575" },
          { key: 10, text: "toolManager.currentTool = toolManager.defaultTool", loc: "50 650" },
          { key: 11, text: "doDeactivate()", loc: "50 725" },
          { key: 12, text: "doStop()", loc: "50 800" }
        ],
        linkDataArray: 
        [
          { from: 1, to: 2, text: "on each tool", segmentOffset: new go.Point(0,-40) },
          { from: 2, to: 3, text: "if returns true", segmentOffset: new go.Point(0,-45) },
          { from: 3, to: 4 },
          { from: 4, to: 5 },
          { from: 5, to: 6 },
...
<script>goCode("toolLifecycle", 600, 900)</script>
<p>
